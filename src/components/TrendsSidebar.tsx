...
const getTrendyTopics = unstable_cache(
    async () => {
...
async function TrendingTopics() {
    const trendtTopics = await getTrendyTopics();

    return <div className="space-y-5 rounded-2xl bg-card p-5 shadow-sm">
        <div className="text-xl font-bold">Trendy Topics</div>
        {
            trendtTopics.map(({hashtag, count}) => {
