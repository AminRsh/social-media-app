        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <div className="space-y-1.5">
                    ...
                    onImageCropprd={setCroppedAvatar}
                    />
                </div>
                <Form {...form}>
...
interface AvatarInputProps {
    ...
    onImageCropprd: (blob: Blob | null) => void 
}

function AvatarInput({ src, onImageCropprd }: AvatarInputProps) {
    ...
    return (
        <>
            ...
            >
                ...
                />
                <span className="absolute inset-0 m-auto flex items-center justify-center bg-black rounded-full bg-opacity-30 text-white transition-colors duration-200 group-hover:bg-opacity-25 size-12">
                    <Camera size={24} />
                </span>
            </button>
            {imageToCrop && (
